use crate::constants::{SEG_KCODE, SEG_KDATA, SEG_UCODE, SEG_UDATA, SEG_TSS, STA_X, STA_W, STA_R, STARTPROC, PROCSIZE, DPL_USER, STS_T32A};
...
pub fn seginit() {
    unsafe {
        ...
        c.gdt[SEG_UCODE as usize] = SegDesc::seg(STA_X | STA_R, STARTPROC, (PROCSIZE << 12) - 1, DPL_USER);
        c.gdt[SEG_UDATA as usize] = SegDesc::seg(STA_W, STARTPROC, (PROCSIZE << 12) - 1, DPL_USER);
